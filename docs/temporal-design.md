...
- [Temporal Design](#temporal-design)
  - [General Overview](#general-overview)
    - [Date-Led User Experience](#date-led-user-experience)
    - [System-Assigned Temporal Precision](#system-assigned-temporal-precision)
    - [Narrative vs Structural Time](#narrative-vs-structural-time)
      - [Narrative Time](#narrative-time)
      - [Structural Time](#structural-time)
    - [Stable Same-Day Ordering](#stable-same-day-ordering)
    - [Lifecycle Dominance](#lifecycle-dominance)
    - [Structural Integrity Over Narrative Flexibility](#structural-integrity-over-narrative-flexibility)
      - [Structural integrity takes precedence](#structural-integrity-takes-precedence)
    - [Temporal Mutability Model](#temporal-mutability-model)
    - [Naming and Schema Reality](#naming-and-schema-reality)
    - [Schema as Temporal Contract](#schema-as-temporal-contract)
    - [Explicit Non-Goals](#explicit-non-goals)
    - [Future Considerations](#future-considerations)
  - [Plant Temporal Model](#plant-temporal-model)
    - [Overview](#overview)
    - [Temporal Fields](#temporal-fields)
      - [acquisitionDate](#acquisitiondate)
      - [endDate](#enddate)
    - [Lifecycle Termination Behaviour](#lifecycle-termination-behaviour)
    - [Reactivation Behaviour](#reactivation-behaviour)
    - [Split Lifecycle Invariants](#split-lifecycle-invariants)
    - [Narrative vs Structural Temporal Roles](#narrative-vs-structural-temporal-roles)
    - [UI Temporal Behaviour (Current Direction)](#ui-temporal-behaviour-current-direction)
    - [Accessibility of Ended Plants](#accessibility-of-ended-plants)
    - [Location Lifecycle Interaction](#location-lifecycle-interaction)
  - [Repotting Temporal Model](#repotting-temporal-model)
    - [Overview](#overview-1)
    - [Temporal Field](#temporal-field)
      - [repotDate](#repotdate)
    - [Narrative Temporal Behaviour](#narrative-temporal-behaviour)
    - [Lifecycle Interaction Rules](#lifecycle-interaction-rules)
    - [Ordering Semantics](#ordering-semantics)
    - [Interaction with Split Lifecycle](#interaction-with-split-lifecycle)
    - [Structural Classification](#structural-classification)
  - [Flowering Temporal Model](#flowering-temporal-model)
    - [Overview](#overview-2)
    - [Temporal Fields](#temporal-fields-1)
      - [startDate](#startdate)
      - [endDate](#enddate-1)
    - [Interval Semantics](#interval-semantics)
    - [Narrative Temporal Behaviour](#narrative-temporal-behaviour-1)
    - [Lifecycle Interaction Rules](#lifecycle-interaction-rules-1)
    - [Ordering Semantics](#ordering-semantics-1)
    - [Structural Classification](#structural-classification-1)
    - [Future Temporal Direction](#future-temporal-direction)
  - [Observation Temporal Model](#observation-temporal-model)
    - [Overview](#overview-3)
    - [Temporal Field](#temporal-field-1)
      - [eventDateTime](#eventdatetime)
    - [Narrative Event Behaviour](#narrative-event-behaviour)
    - [Lifecycle Interaction Rules](#lifecycle-interaction-rules-2)
    - [Ordering Semantics](#ordering-semantics-2)
    - [Structural Classification](#structural-classification-2)
  - [Location Temporal Model](#location-temporal-model)
    - [Overview](#overview-4)
    - [Temporal Fields](#temporal-fields-2)
    ...
    - [Lifecycle Operations](#lifecycle-operations)
      ...
      - [Edit](#edit)
      - [Remove](#remove)
    - [Narrative vs Structural Behaviour](#narrative-vs-structural-behaviour)
    - [UI Temporal Behaviour](#ui-temporal-behaviour)
      - [Move](#move-1)
      - [Edit](#edit-1)
      - [Display](#display)
    - [Lifecycle Interaction](#lifecycle-interaction)
    - [Structural Classification](#structural-classification-3)
  - [Split Temporal Model](#split-temporal-model)
    - [Overview](#overview-5)
    - [Temporal Field](#temporal-field-2)
      - [splitDateTime](#splitdatetime)
    - [Structural Lifecycle Behaviour](#structural-lifecycle-behaviour)
      - [Parent plant](#parent-plant)
      - [Child plants](#child-plants)
      - [Lineage](#lineage)
    - [Temporal Alignment](#temporal-alignment)
    - [Location Interaction](#location-interaction)
    - [Transactional Behaviour](#transactional-behaviour)
    - [Structural Classification](#structural-classification-4)
    - [Constraints and Invariants](#constraints-and-invariants)
    - [Narrative vs Structural Behaviour](#narrative-vs-structural-behaviour-1)
    - [Future Temporal Considerations](#future-temporal-considerations)
