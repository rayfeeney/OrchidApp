CREATE TABLE IF NOT EXISTS `growthmedium` (
  ...
  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Name of the growing medium, e.g. "Orchid Focus", "Sphagnum Moss", "Bark Chips"',
  `description` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Optional description or notes about the growing medium',
