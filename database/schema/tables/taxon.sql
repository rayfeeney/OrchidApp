CREATE TABLE IF NOT EXISTS `taxon` (
  ...
  `taxonNotes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  `genusSpeciesKey` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci GENERATED ALWAYS AS ((case when (`speciesName` is not null) then concat(`genusId`,_utf8mb4':',`speciesName`) else NULL end)) STORED,
  `genusHybridKey` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci GENERATED ALWAYS AS ((case when (`hybridName` is not null) then concat(`genusId`,_utf8mb4':',`hybridName`) else NULL end)) STORED,
