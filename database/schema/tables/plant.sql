CREATE TABLE IF NOT EXISTS `plant` (
  ...
  `endReasonCode` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Reason plant left collection (Died, GivenAway, Split, etc)',
  `endDate` datetime DEFAULT NULL COMMENT 'Date plant left collection or was removed by split',
  `endNotes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Free-text explanation of plant end-of-life',
