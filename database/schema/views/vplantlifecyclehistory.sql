...
AS datetime)
AS `eventDateTime`,'Repotting' collate utf8mb4_unicode_ci
...
AS datetime)
AS `eventDateTime`,'Flowering' collate utf8mb4_unicode_ci
...
AS `eventDateTime`,'LocationChange' collate utf8mb4_unicode_ci
