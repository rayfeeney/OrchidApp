...
BEGIN
    ...
    -- Lock and validate parent plant
    ...
    -- Parse + validate child tags into a temp table (no mutations yet)
    ...
    -- Now mutate state: create split event row
    ...
    -- End parent lifecycle (still isActive = 1)
    UPDATE plant
