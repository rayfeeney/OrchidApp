CREATE TABLE IF NOT EXISTS plantpropagation (
  ...
  KEY ixPlantPropagation_parentPlantId (parentPlantId),
  KEY ixPlantPropagation_propagationTypeId (propagationTypeId),
  CONSTRAINT fkPlantPropagation_parentPlantId
    FOREIGN KEY (parentPlantId) REFERENCES plant (plantId),
  CONSTRAINT fkPlantPropagation_childPlantId
    FOREIGN KEY (childPlantId) REFERENCES plant (plantId),
  CONSTRAINT fkPlantPropagation_propagationTypeId
    FOREIGN KEY (propagationTypeId) REFERENCES propagationtype (propagationTypeId),
